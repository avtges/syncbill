  ...
  return (
    <DefaultCard>
      <form onSubmit={addCard}>
        <CardTitle className='form-control border' name='title' autoFocus defaultValue='Title' ref={inputCardTitle} />
        <CardDescription className='form-control border' name='description' defaultValue='Amount' ref={inputCardDescription} />
        <StyledFormButtons>
